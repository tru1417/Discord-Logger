...
import { MessageSquare, ShieldAlert, Gavel, Clock } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <motion.div variants={item} className="lg:col-span-2 bg-[#2f3136] rounded-xl border border-[#202225] overflow-hidden">
